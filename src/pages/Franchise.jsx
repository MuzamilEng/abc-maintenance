  ...
  const servicesExamples = [
    {
      ...
      description:
        "Our team has successfully renovated numerous kitchens and bathrooms, delivering stylish and functional spaces that meet our clients' unique needs and preferences.",
    },
    {
      title: "Driveways & Patios",
      description:
        "We have transformed outdoor areas with our expert paving services, creating beautiful and durable driveways and patios that enhance curb appeal and usability.",
    },
    {
      title: "Property Maintenance",
      description:
        "From routine maintenance tasks to major property upgrades, we have helped homeowners and businesses maintain their properties in top condition.",
    },
    {
      title: "Flooring Solutions",
      description:
        "Our extensive experience in flooring ensures that we can provide and install the perfect flooring solution for any room, adding both beauty and value to your property.",
    },
    {
      title: "Painting & Decorating",
      description:
        "Our skilled painters and decorators have brought new life to countless homes and offices, creating inviting and vibrant environments.",
    },
  ];
      ...
      <div id="content" className="main-content" role="main">
        <div className="wrap" id="text_content">
          <section
            ...
            style={{
              backgroundImage: 'url("/img/mainti6.jpg")',
            }}
          >
                  ...
                  >
                    <div className="section__content ">
                      ...
                      <h2 className="lg:text-[1.5vw]">
                        At ABC Home Services, we take pride in the quality of
                        our work and the satisfaction of our clients. Here are
                        some of the projects we have completed across Yorkshire:
                      </h2>
                      <div
                        style={{ marginTop: "2vw" }}
                      ...
                      >
                        {servicesExamples.map((service, index) => (
                          <div key={index}>
                            <h2 className="text-align-left mt-[1vw] lg:text-[1.5vw] font-bold">
                              {service.title}
                            </h2>
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw]">
                        ABC is the only franchise of its kind in the growing
                        home improvement and repair industry. If you have a
                        passion for home improvements and you are looking to own
                        a scalable business with a short startup time and low,
                        initial investment, this is your opportunity.
                      </p>
                ...
                <div className="col-md-12">
                  ...
                  >
                    <div className="section__content lg:mt-[4vw]">
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw]">
                        The ABC Plan was created to provide homeowners with a
                        dependable solution to home maintenance and repairs
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw] lg:mt-[1vw]">
                        ABC is the only home repair franchise of its kind that
                        offers the benefits of a membership model in the home
                        improvement space. Membership creates repeat business
                        opportunities to get “back in the home” and win more
                        business.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="section__content ">
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw] lg:mt-[1vw]">
                        ...
                        our competitors, ABC is poised to disrupt the home
                        services sector.
                      </p>
                      <p className="lg:text-[1.2vw] lg:leading-[2vw] lg:mt-[1vw]">
                  ...
                  >
                    <div className="section__content ">
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw] lg:mt-[1vw]">
                        ...
                        construction to be a successful ABC business owner. We
                        are looking for individuals who are passionate about
                        entrepreneurship and the following characteristics and
                        experience:
                      </p>
                      <ul className="lg:text-[1.2vw] lg:list-disc lg:ml-[2vw] lg:mt-[1vw]">
                ...
                <div className="col-md-6 mt-5 mt-md-0">
                  ...
                  >
                    <div className="section__content ">
                      ...
                      <p className="lg:text-[1.2vw] lg:leading-[2vw] lg:mt-[1vw]">
                        ABC is expanding. With franchise opportunities available
                        across the United States, ABC is looking for driven
                        people who want to be in business for themselves, but
                        not by themselves. If you have great aptitude and a
                        great attitude, and if you are ready to reach your
                        dreams through entrepreneurship, contact us today.
                      </p>
                    </div>
                  </div>
                </div>
